...
export default function Home({ navigation }) {
  ...
  const fetchApiImages = async () => {
    try {
      ...
      console.log("Error fetching API images");
    }
  };
  ...
  return (
      <View style={styles.container}>
        <ImageBackground
            source={Platform.OS === "ios" ? bg : "none"}
            resizeMode="cover"
            style={styles.bg}
        >
          ...
          <TouchableOpacity
              onPress={() => setShowApiImages(!showApiImages)}
              style={styles.toggleButtonContainer}
          >
            <Text style={styles.toggleButton}>
              {showApiImages
                  ? "Скрыть изображения из API"
                  : "Показать изображения из API"}
            </Text>
          </TouchableOpacity>
          {showApiImages && (
              <FlatList
          ...
          <Button
              ...
              onPress={uploadCatImage}
          />

          <TouchableOpacity
              onPress={() => setShowLocalImages(!showLocalImages)}
              style={styles.toggleButtonContainer}
          >
            <Text style={styles.toggleButton}>
              {showLocalImages
                  ? "Скрыть загруженные изображения"
